...
public class PropagatedContextInstrumentation extends MicronautInstrumentation {
    ...
    public ElementMatcher<? super NamedElement> getTypeMatcherPreFilter() {
        return nameStartsWith("io.micronaut.core.propagation");
    }

    @Override
    public ElementMatcher<? super TypeDescription> getTypeMatcher() {
        return hasSuperType(named("io.micronaut.core.propagation.PropagatedContextImpl"));
    }

    @Override
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        return isConstructor().and(takesArguments(2));
    }
