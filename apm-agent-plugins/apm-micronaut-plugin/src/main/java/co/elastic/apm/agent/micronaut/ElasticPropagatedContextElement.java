...
public class ElasticPropagatedContextElement implements ThreadPropagatedContextElement<Transaction<?>> {
    private Transaction<?> transaction;

    public ElasticPropagatedContextElement(Transaction<?> transaction) {
